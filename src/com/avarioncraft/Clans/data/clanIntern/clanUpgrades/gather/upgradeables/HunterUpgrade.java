...
public class HunterUpgrade extends UpgradeComponent implements IJobUpgrade{

	public HunterUpgrade(UpgradePointSystem system, Clan clan, String displayName) {
		super(10, system, clan, displayName);
		this.type = GatherJobUpgradeType.HUNTER;
	}
	
	private BaseExpBuff buff = new BaseExpBuff(Job.HUNTER, 10);
