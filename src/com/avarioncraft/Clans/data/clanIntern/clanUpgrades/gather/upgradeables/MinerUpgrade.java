...
public class MinerUpgrade extends UpgradeComponent implements IJobUpgrade{

	public MinerUpgrade(UpgradePointSystem system, Clan clan, String displayName) {
		super(10, system, clan, displayName);
		this.type = GatherJobUpgradeType.MINER;
	}
	
	private BaseExpBuff buff = new BaseExpBuff(Job.MINER, 10);
