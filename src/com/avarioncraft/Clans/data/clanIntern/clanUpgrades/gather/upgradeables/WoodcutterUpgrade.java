...
public class WoodcutterUpgrade extends UpgradeComponent implements IJobUpgrade{

	public WoodcutterUpgrade(UpgradePointSystem system, Clan clan, String displayName) {
		super(10, system, clan, displayName);
		this.type = GatherJobUpgradeType.WOODCUTTER;
	}
	
	private BaseExpBuff buff = new BaseExpBuff(Job.WOODCUTTER, 10);
