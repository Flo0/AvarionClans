...
public class SmithUpgrade extends UpgradeComponent implements IJobUpgrade{

	public SmithUpgrade(UpgradePointSystem system, Clan clan, String displayName) {
		super(10, system, clan, displayName);
		this.type = ProducerJobUpgradeType.SMITH;
	}
	
	private BaseExpBuff buff = new BaseExpBuff(Job.SMITH, 10);
