...
public class CraftshipUpgrade extends UpgradeComponent implements IJobUpgrade{

	public CraftshipUpgrade(UpgradePointSystem system, Clan clan, String displayName) {
		super(10, system, clan, displayName);
		this.type = ProducerJobUpgradeType.CRAFTSMAN;
	}
	
	private BaseExpBuff buff = new BaseExpBuff(Job.CRAFTER, 10);
