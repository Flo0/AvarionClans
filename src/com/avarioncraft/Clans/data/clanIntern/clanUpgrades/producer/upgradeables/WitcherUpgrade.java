...
public class WitcherUpgrade extends UpgradeComponent implements IJobUpgrade{

	public WitcherUpgrade(UpgradePointSystem system, Clan clan, String displayName) {
		super(10, system, clan, displayName);
		this.type = ProducerJobUpgradeType.WITCHER;
	}
	
	private BaseExpBuff buff = new BaseExpBuff(Job.WITCHER, 10);
