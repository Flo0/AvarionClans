...
public class JewlerUpgrade extends UpgradeComponent implements IJobUpgrade{

	public JewlerUpgrade(UpgradePointSystem system, Clan clan, String displayName) {
		super(10, system, clan, displayName);
		this.type = ProducerJobUpgradeType.JEWLER;
	}
	
	private BaseExpBuff buff = new BaseExpBuff(Job.JEWELER, 10);
