...
public class PenetrationUpgrade extends UpgradeComponent implements IArmoryUpgrade{

	public PenetrationUpgrade(UpgradePointSystem system, Clan clan, String displayName) {
		super(5, system, clan, displayName);
		this.type = ArmoryUpgradeType.PENETRATION;
	}
	...
	public int getUpgradeCost() {
		return super.getLevel() + 10 + (super.getLevel() * 10);
	}
	...
	public void applyFor(Player player) {
		...
		UpgradeBuff buff = new UpgradeBuff(player, Stat.ARMOR_PENETRATION, percentBuff);
		buff.setDisplayName("§eClan Buff: §f" + super.getDisplayName());
		buff.addDescLine("");
		buff.addDescLine("§f[§a+§f] Dieser Buff erhöht deine §7zusätzliche §fRüstungs-");
		buff.addDescLine("§fdurchdringung um §e" + percentBuff + "%");
		buff.setIconMaterial(Material.IRON_SHOVEL);
